...
INFRA_GIT=https://github.com/digicatapult/veritable-infra.git
INFRA_BRANCH=main
CONTEXT_NAME=kind-veritable-infra
...
while getopts ":g:b:c::p:h" opt; do
  case ${opt} in
    ...
    p )
      ...
      ;;
   \? )
     echo "Invalid Option: -$OPTARG" 1>&2flux 
     echo "\n"
     print_usage
     exit 1
     ;;
